...
class FeatureData {
    ...
    static let achievements: [Achievement] = [
        ...
        Achievement(id: "gamer", name: "Jucator", nameEn: "Gamer", description: "Ai jucat toate cele 6 jocuri", descriptionEn: "You played all 6 games", icon: "\u{1F3AE}", requirement: "6 jocuri jucate", requirementEn: "6 games played", color1: "4FC3F7", color2: "0288D1"),
